...
public class Board {
	...
	public void placeStartingPieces() {
		...
		this.board[1][0].addPiece(new Piece("h", 0, new Position(1, 0)));	
		this.board[6][0].addPiece(new Piece("h", 0, new Position(6, 0)));	
		this.board[1][7].addPiece(new Piece("h", 1, new Position(1, 7)));	
		this.board[6][7].addPiece(new Piece("h", 1, new Position(6, 7)));	
